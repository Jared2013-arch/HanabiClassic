...
public class ColorUtils {
    ...
    public static String getHexName(Color color) {
        ...
        return (rHex.length() == 2 ? new StringBuilder().append(rHex).toString() : new StringBuilder("0").append(rHex).toString()) + (gHex.length() == 2 ? new StringBuilder().append(gHex).toString() : new StringBuilder("0").append(gHex).toString()) + (bHex.length() == 2 ? new StringBuilder().append(bHex).toString() : new StringBuilder("0").append(bHex).toString());
    }

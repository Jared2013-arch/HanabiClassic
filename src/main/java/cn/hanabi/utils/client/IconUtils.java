...
public class IconUtils {
    public static ByteBuffer[] getFavicon() {
        try {
            return new ByteBuffer[]{readImageToBuffer(IconUtils.class.getResourceAsStream("/assets/minecraft/Client/logo16.png")), readImageToBuffer(IconUtils.class.getResourceAsStream("/assets/minecraft/Client/logo32.png"))};
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;

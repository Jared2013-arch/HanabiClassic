...
public class MusicPlayerUI extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if(extended) {
			Hanabi.INSTANCE.fontManager.micon15.drawString("C", x + width - 15, y + 10, Color.WHITE.getRGB());
		} else {
			Hanabi.INSTANCE.fontManager.micon15.drawString("Q", x + width - 15, y + 10, Color.WHITE.getRGB());
		}
		...
		if(MusicManager.INSTANCE.getMediaPlayer() != null) {
			if(MusicManager.INSTANCE.getMediaPlayer().getStatus() == Status.PLAYING) {
				Hanabi.INSTANCE.fontManager.micon30.drawString("K", x + (width / 2) - (Hanabi.INSTANCE.fontManager.micon30.getStringWidth("K") / 2), y + height - 32+5, Color.WHITE.getRGB());
			} else {
				Hanabi.INSTANCE.fontManager.micon30.drawString("J", x + (width / 2) - (Hanabi.INSTANCE.fontManager.micon30.getStringWidth("J") / 2), y + height - 32+5, Color.WHITE.getRGB());
			}
		...
		Hanabi.INSTANCE.fontManager.micon30.drawString("L", x + width / 2 - (Hanabi.INSTANCE.fontManager.micon30.getStringWidth("L") / 2) - 30, y + height - 32+5, Color.WHITE.getRGB());
		Hanabi.INSTANCE.fontManager.micon30.drawString("M", x + width / 2 - (Hanabi.INSTANCE.fontManager.micon30.getStringWidth("M") / 2) + 27.5f, y + height - 32+5, Color.WHITE.getRGB());

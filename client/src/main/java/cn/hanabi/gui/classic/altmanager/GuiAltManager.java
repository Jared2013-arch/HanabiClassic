...
//                }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float par3) {
        ...
        if (!Client.onDebug) {
            RenderUtil.drawImage(new ResourceLocation("Client/classic/mainmenu/mainmenu.png"), -30, -30, sr.getScaledWidth() + 60,
                    sr.getScaledHeight() + 60);
        } else {
            RenderUtil.drawImage(new ResourceLocation("Client/classic/mainmenu/scifi.png"), -30, -30, sr.getScaledWidth() + 60,
                    sr.getScaledHeight() + 60);
        }

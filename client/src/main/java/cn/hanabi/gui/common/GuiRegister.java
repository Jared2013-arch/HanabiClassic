...
public class GuiRegister extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, 240, "Back"));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.mc.fontRendererObj, "Hanabi Regitser", this.width / 2, 20, -1);
        ...
        try {
            ...
            switch (button.id) {
                case 1: {
                    ...
                    ClientHandler.context.writeAndFlush(PacketUtil.pack(new PacketRegister(username.getText(), password.getText(), key.getText())));
                    break;
                }
                case 2:

package cn.hanabi.gui.newStyle.clickui.misc;
...
//        double radius = 15 * anima.getX() / 100;
        ...
        int c = Hanabi.INSTANCE.newStyle ? new Color(82, 161, 254, alpha).getRGB() : new Color(255, 255, 255, alpha).getRGB();
        RenderUtil.drawArc(x, y, radius, c, 0, 360, 5);

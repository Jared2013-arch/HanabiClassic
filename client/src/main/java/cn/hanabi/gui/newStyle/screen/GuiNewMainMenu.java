...
//        RenderUtil.drawImage(new ResourceLocation("Client/new/mainmenu/bg.png"), 0, 0, sr.getScaledWidth(), sr.getScaledHeight());
        ...
        Hanabi.INSTANCE.fontManager.wqy16.drawString("[+] New Design", 50, 70, new Color(160, 160, 160).getRGB());
        Hanabi.INSTANCE.fontManager.wqy16.drawString("[+] AAC & Vulcan bypasses", 50, 85, new Color(160, 160, 160).getRGB());
        Hanabi.INSTANCE.fontManager.wqy16.drawString("[+] Other bypasses", 50, 100, new Color(160, 160, 160).getRGB());
...
//        Hanabi.INSTANCE.fontManager.wqy16.drawString("[~] Bug fixes", 50, 130, new Color(160, 160, 160).getRGB());
        ...
        for (int i = 0; i < 4; i++) {
            ...
            String str = strs[i];
            if (RenderUtil.isHoveringAppend(mouseX, mouseY, x, y, width1, 32)) {
                RenderUtil.drawCustomImage2(x - 10, y - 10, 309 / 2, height2, new ResourceLocation("Client/new/mainmenu/selection.png"));

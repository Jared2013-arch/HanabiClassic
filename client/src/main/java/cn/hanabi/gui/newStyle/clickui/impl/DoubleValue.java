...
public class DoubleValue {
    ...
    public void draw(float x, float y, float mouseX, float mouseY) {
        ...
        RenderUtil.drawRoundRect(x + 130, y + 11, x + 220, y + 13, 1, new Color(238,238,238, 255).getRGB());
        RenderUtil.drawRoundRect(x + 130, y + 11, x + 130 + anima.getX(), y + 13, 1, new Color(72,151,244, 255).getRGB());
